...
import {
  ProjectionInputsBar, ProjInputGroup, ProjLabel, ProjInput, EndYearBadge,
  ProjectionChartArea, MonthlyValuesPanel, MonthlyValuesHeader, MonthlyValueRow,
  MonthRowLabel, MonthRowValue,
} from './WealthProjection.styles';
